...
public class Aim extends CommandBase {
    ...
    public void execute() {
        ...
        double robotHeading = Math.toDegrees(r.getAlliance() == Alliance.RED ? r.getFollower().getPose().getHeading() - Math.toRadians(90) : r.getFollower().getPose().getHeading() + Math.toRadians(90));
